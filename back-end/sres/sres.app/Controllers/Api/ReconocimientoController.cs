...
namespace sres.app.Controllers.Api
{
    ...
    public class ReconocimientoController : ApiController
    {
        ...
        [HttpGet]
        public DataPaginateBE BuscarParticipantes(string razonSocialInstitucion, int? idTipoEmpresa, int? idCriterio, int? idMedMit, int? añoInicioConvocatoria, int? idInsignia, int? idEstrella, int registros, int pagina, string columna, string orden)
        {
            List<ReconocimientoBE> reconocimiento = reconocimientoLN.BuscarParticipantes(razonSocialInstitucion, idTipoEmpresa, idCriterio, idMedMit, añoInicioConvocatoria, idInsignia, idEstrella, registros, pagina, columna, orden);
