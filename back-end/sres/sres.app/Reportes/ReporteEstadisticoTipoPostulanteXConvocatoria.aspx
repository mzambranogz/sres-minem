<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteEstadisticoTipoPostulanteXConvocatoria.aspx.cs" Inherits="sres.app.Reportes.ReporteEstadisticoTipoPostulanteXConvocatoria" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row" style="overflow-y: scroll;">
            <rsweb:ReportViewer ID="rpwReporte" runat="server" Style="width: 100%" Visible="false">
                <LocalReport ReportPath="App_Data/Reportes/rptReporteEstadisticoTipoPostulanteXConvocatoria.rdlc"></LocalReport>
            </rsweb:ReportViewer>
        </div>
    </form>
</body>
