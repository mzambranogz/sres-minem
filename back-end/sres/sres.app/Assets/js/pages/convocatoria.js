...
var renderizar = (data, cantidadCeldas) => {
    ...
    if (deboRenderizar) {
        contenido = data.DATA.map((x, i) => {
            ...
            let colNombre = `<td data-encabezado="Progreso"><div class="text-limi-1">${x.DESCRIPCION}</div></td>`;
            ...
            let btnDetalles = `<a class="btn btn-sm btn-success w-100" href="${baseUrl}Convocatoria/${x.ID_CONVOCATORIA}/Detalle">Detalles</a>`;
            ...
            let btnDescargarReconocimiento = `<a class="dropdown-item estilo-01" href="javascript:void(0)" onclick="descargar('${x.ID_CONVOCATORIA}','${idInstitucionLogin}')"><i class="fas fa-download mr-1"></i>Descargar Reconocimiento</a>`;
...
var descargar = (idconvocatoria, idinstitucion) => {
