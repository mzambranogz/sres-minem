    ...
    if (data.length > 0) {
        ...
        let contenido = data.map(x => {
            ...
            if (existeFileRequerimientoSubido) {
                ...
                contenidoFileRequerimiento = `<div class="alert alert-success p-1 d-flex w-100"><div class="mr-auto">${nombreFileRequerimiento}</div><div class="ml-auto">${btnDescargaFileRequerimiento}${btnEliminarFileRequerimiento}</div></div>`;
            }
            ...
            let colRight = `<div class="col-lg-6 col-md-12 col-sm-12 d-flex align-items-end" id="viewContentFile-${x.ID_REQUERIMIENTO}"><label class="estilo-01">&nbsp;</label>${contenidoFileRequerimiento}</div>`;
