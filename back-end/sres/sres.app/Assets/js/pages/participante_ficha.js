...
var reconocimientocategoriaestrella = (obj) => {    
    ...
    let head = `<thead class="estilo-06 free-with"><tr><th scope="col" width="50%"><div class="d-flex justify-content-between align-items-center"><span class="d-flex justify-content-between align-items-center"><i class="fas fa-question-circle mr-1" data-toggle="tooltip" data-placement="bottom" title="Puntuación obtenida"></i><span>PUNTAJE&nbsp;</span></span></div></th><th scope="col" width="50%"><div class="d-flex justify-content-between align-items-center"><span class="d-flex justify-content-between align-items-center"><i class="fas fa-question-circle mr-1" data-toggle="tooltip" data-placement="bottom" title="Reducción lograda"></i><span>REDUCCIÓN&nbsp;</span></span></div></th></tr></thead>`;
    ...
    if (obj.LISTA_REC_MEDMIT != null) {
        if (obj.LISTA_REC_MEDMIT.length > 0) {
            let tablas = obj.LISTA_REC_MEDMIT.map((x, y) => {
                ...
                let head = `<thead class="estilo-06 free-with"><tr><th scope="col" width="50%"><div class="d-flex justify-content-between align-items-center"><span class="d-flex justify-content-between align-items-center"><i class="fas fa-question-circle mr-1" data-toggle="tooltip" data-placement="bottom" title="Reducción lograda"></i><span>REDUCCIÓN&nbsp;</span></span></div></th></tr></thead>`;
                let contentseccion = `<div class="col-lg-6 col-md-12 col-sm-12"><div class="table-responsive tabla-principal"><table class="table table-sm table-hover mb-0">${head}${body}</table></div></div>`;
