...
var resultado = (obj) => {
    let puntaje = `<div class="col-lg-3 col-md-6 col-sm-12 text-center my-3"><div class="alert alert-success p-0"><div class="badge badge-success badge-sres p-1 py-2"><small class="estilo-02">Total de Puntaje obtenido en la convocatoria</small></div><div class="text-sres-azul"><span class="d-block estilo-09 mt-3">${obj.PUNTAJE}</span><smal class="d-block estilo-01 mb-3 encima">de 100 puntos potenciales</smal></div><i class="fas fa-chart-line fa-3x mb-3"></i></div></div>`;
