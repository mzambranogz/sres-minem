        ...
        IF vID = 0 THEN
            ...
            IF PI_ID_TIPO_CONTROL = 1 THEN
                INSERT INTO T_MAEM_PARAMETRO (ID_PARAMETRO, NOMBRE, ETIQUETA, ID_TIPO_CONTROL, DESCRIPCION, UNIDAD, TAMANO,
                                              ESTATICO, EDITABLE, VERIFICABLE, FILTRO, DECIMAL_V, RESULTADO, EMISIONES, AHORRO, REG_USUARIO, REG_FECHA)
                VALUES (PI_ID_GET, PI_NOMBRE, PI_ETIQUETA, PI_ID_TIPO_CONTROL, PI_DESCRIPCION, PI_UNIDAD, PI_TAMANO,
                        PI_ESTATICO, PI_EDITABLE, PI_VERIFICABLE, PI_FILTRO, PI_DECIMAL_V, PI_RESULTADO, PI_EMISIONES, PI_AHORRO, PI_USUARIO_GUARDAR, SYSDATE);
            ELSE
                INSERT INTO T_MAEM_PARAMETRO (ID_PARAMETRO, NOMBRE, ETIQUETA, ID_TIPO_CONTROL, ID_TIPO_DATO, DESCRIPCION, UNIDAD, TAMANO,
                                              ESTATICO, EDITABLE, VERIFICABLE, DECIMAL_V, RESULTADO, EMISIONES, AHORRO, REG_USUARIO, REG_FECHA)
                VALUES (PI_ID_GET, PI_NOMBRE, PI_ETIQUETA, PI_ID_TIPO_CONTROL, PI_ID_TIPO_DATO, PI_DESCRIPCION, PI_UNIDAD, PI_TAMANO,
                        PI_ESTATICO, PI_EDITABLE, PI_VERIFICABLE, PI_DECIMAL_V, PI_RESULTADO, PI_EMISIONES, PI_AHORRO, PI_USUARIO_GUARDAR, SYSDATE);
            END IF;
