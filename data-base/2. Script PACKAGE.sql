  ...
  BEGIN
    ...
    IF vID IS NULL THEN
      ...
      IF vCONT > 0 THEN
        ...
        (ID_CRITERIO, ID_CASO, ID_COMPONENTE, NOMBRE, INCREMENTABLE, REG_USUARIO, REG_FECHA)
        VALUES
        (PI_ID_CRITERIO, PI_ID_CASO, vID, PI_NOMBRE, PI_INCREMENTABLE, PI_USUARIO_GUARDAR, SYSDATE);
      ELSE
        INSERT INTO T_GENM_COMPONENTE
        (ID_CRITERIO, ID_CASO, ID_COMPONENTE, NOMBRE, INCREMENTABLE, REG_USUARIO, REG_FECHA)
        VALUES
        (PI_ID_CRITERIO, PI_ID_CASO, 1, PI_NOMBRE, PI_INCREMENTABLE, PI_USUARIO_GUARDAR, SYSDATE);
      END IF;      
