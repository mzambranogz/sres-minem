...
CREATE OR REPLACE PACKAGE BODY SISSELLO."PKG_SISSELLO_CRITERIO" AS
  ...
  BEGIN
    ...
    (SELECT PUNTAJE FROM T_GEND_CONV_CRI_CASO_INSC_DATA INSD WHERE INSD.ID_CRITERIO = CR.ID_CRITERIO AND INSD.ID_CONVOCATORIA = PI_ID_CONVOCATORIA AND INSD.ID_INSCRIPCION = PI_ID_INSCRIPCION) PUNTAJE,
