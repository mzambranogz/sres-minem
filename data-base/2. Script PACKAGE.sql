...
CREATE OR REPLACE PACKAGE BODY SISSELLO."PKG_SISSELLO_MANTENIMIENTO" AS
  ...
  BEGIN
    ...
    IF vID IS NULL THEN
      ...
      (ID_CRITERIO, NOMBRE, DESCRIPCION, ARCHIVO_BASE, ID_CATEGORIA, REG_USUARIO, REG_FECHA)
      VALUES
      (PI_ID_GET, PI_NOMBRE, PI_DESCRIPCION, PI_ARCHIVO_BASE, PI_ID_CATEGORIA, PI_USUARIO_GUARDAR, SYSDATE);
    ELSE
