...
CREATE OR REPLACE PACKAGE BODY SISSELLO."PKG_SISSELLO_CRITERIO" AS
  ...
  BEGIN
    ...
    IF vCONT = 0 THEN 
      INSERT INTO T_GEND_CONV_CRI_CASO_INSC_DATA (ID_CONVOCATORIA, ID_CRITERIO, ID_CASO, ID_INSCRIPCION, INGRESO_DATOS, PUNTAJE, EMISIONES, ENERGIA, COMBUSTIBLE, REG_USUARIO, REG_FECHA)
      VALUES (PI_ID_CONVOCATORIA, PI_ID_CRITERIO, PI_ID_CASO, PI_ID_INSCRIPCION, '1', (SELECT NVL(AVG(PUNTAJE),0) FROM T_GEND_CONV_CRI_PUNTAJE
                                                                                      ...
                                                                                      AND ID_CRITERIO = PI_ID_CRITERIO AND PUNTAJE > 0), PI_EMISIONES, PI_ENERGIA, PI_COMBUSTIBLE, PI_USUARIO_GUARDAR, SYSDATE);
    ELSE
  ...
  BEGIN
    ...
    IF vCONT = 0 THEN 
      INSERT INTO T_GEND_CONV_CRI_PUNT_INSC (ID_CONVOCATORIA, ID_CRITERIO, ID_DETALLE, ID_INSCRIPCION, ID_TIPO_EVALUACION, EMISIONES_REDUCIDAS, ENERGIA, COMBUSTIBLE, OBSERVACION, REG_USUARIO, REG_FECHA)
      VALUES (PI_ID_CONVOCATORIA, PI_ID_CRITERIO, PI_ID_DETALLE, PI_ID_INSCRIPCION, PI_ID_TIPO_EVALUACION, PI_EMISIONES_REDUCIDAS, PI_ENERGIA, PI_COMBUSTIBLE, PI_OBSERVACION, PI_USUARIO_GUARDAR, SYSDATE);
    ELSE
